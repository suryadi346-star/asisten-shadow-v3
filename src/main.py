...
from terminal.vm_mode import VMShell  # ← FIXED: import yang hilang
import config
    ...
    def _dashboard_menu(self):
        ...
        return UI.menu(
            ...
            [
                ...
                "💻 Shadow VM Shell",    # ← FIXED: comma yang hilang
            ]
        )
